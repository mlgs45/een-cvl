-- ============================================================
-- EEN CRM — Migration 003 : Module "Vie du réseau"
-- ============================================================

-- 1. Ajout is_active sur users (soft-delete)
...
-- Catégories d'activités réseau
CREATE TABLE public.network_activity_categories (
...
-- Objectifs par conseiller × catégorie
CREATE TABLE public.network_objectives (
  id            uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Journal des occurrences réseau
CREATE TABLE public.network_activity_logs (
  id          uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  advisor_id  uuid NOT NULL REFERENCES public.users(id) ON DELETE CASCADE,
...
-- ============================================================
-- 5. SEED : objectifs (par full_name — silencieux si user absent)
-- ============================================================
